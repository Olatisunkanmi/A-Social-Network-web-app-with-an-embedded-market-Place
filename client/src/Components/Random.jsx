...
const Random = () => {
	return (
		<div className='story border-2 border-stone-300 rounded-xl  flex flex-col bg-blue-400 text-white'>
			...
			<div className='text-center flex flex-col items-center'>
				...
				<a
					href=''
					className='font-semibold font-sans p-3 cursor-pointer mt-3 rounded-xl border-2 border-white mb-5
                    hover:bg-white
                    hover:text-blue-500
                    '
				>
