    ...
    <div className="w-full my-5 flex flex-col">
      <div className="flex flex-row items-center justify-between w-full p-2">
        <div className="flex flex-row w-1/4">
          <p className="font-mono text-lg font-bold border-b-2 p-2 border-black cursor-pointer">
            {" "}
            Male Clothings{" "}
          </p>
        </div>
        ...
        <div className="flex flex-col w-2/4">
          <p className="font-mono text-lg font-bold p-2  cursor-pointer">
            {" "}
            Overview
          </p>
        ...
        <div className="w-1/4 flex flex-row">
          <form>
            <label className="font-mono text-lg font-bold cursor-pointer">
              Sort by:
            </label>
