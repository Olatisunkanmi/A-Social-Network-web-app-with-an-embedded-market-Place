...
const story = () => {
  return (
    <div className="story border-2 bg-white border-stone-300 rounded-xl flex flex-col">
      <div className="flex-row flex justify-between p-2 px-3 ">
      ...
      <div className="border-t-2 border-stone-200 p-3 flex flex-row  items-center">
        <div className="mx-5 p-1 border-2 border-dotted rounded-full cursor-pointer border-stone-600 hover:border-solid hover:border-blue-600">
      ...
      <div className="border-t-2 border-stone-200 p-3 flex flex-row  items-center">
        <div
          ...
          cursor-pointer border-stone-600 hover:border-solid hover:border-blue-600"
        >
          <img
            src={img}
            alt=""
