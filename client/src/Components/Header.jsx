...
const Header = () => {
  ...
  return (
    <div
      className="w-full items-center top-0 sticky p-1 flex flex-row bg-white  justify-between border-b-2 
    product-nav"
    >
      ...
      <div className="justify-end text-white items-center flex flex-row rounded-xl  w-2/6 pr-3">
        <div>
          ...
          <input
            ...
            placeholder="Search"
            id=""
            className="p-2 border-2 font-semibold  text-black outline-blue-700 placeholder:text-black placeholder:font-thin rounded-xl"
          />
        </div>
