...
const RecommendedPages = () => {
  ...
  return (
    <div className="RecommendedPages relative border-2 bg-white border-stone-300 rounded-xl flex flex-col">
      <div className="flex-row flex justify-between p-2 px-3 ">
        <p className="text-stone-500 font-semibold"> Recommended Pages </p>

        <button
          className=""
          onClick={() => setDelete((prevDelete) => !prevDelete)}
        >
          <MoreVertOutlined />
        </button>
      </div>
      ...
      <div className="border-t-2 border-stone-200 p-3 flex flex-row  items-center">
        <div className="mx-2 p-1  rounded-full cursor-pointer border-stone-600 hover:border-solid hover:border-blue-600">
          <img
            src={img}
            alt=""
