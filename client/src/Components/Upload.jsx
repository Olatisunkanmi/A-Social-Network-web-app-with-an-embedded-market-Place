...
const Upload = () => {
  return (
    <div className=" flex flex-col bg-white border-2 rounded-xl  border-stone-300">
      <div className="rounded-xl  w-full  flex flex-row ">
        <div className="cursor-pointer flex border-r-2  w-2/6 items-center justify-center rounded-tr-lg py-3">
          <EditOutlined className="upload-icons" />
          <p className="font-mono font-bold "> Publish </p>
        </div>
        <div className="cursor-pointer flex  w-2/6 bg-stone-100 border-b-2 items-center justify-center">
          <PhotoAlbumOutlined className="upload-icons" />
          <p className="font-mono font-bold "> Photo </p>
        </div>

        <div className="cursor-pointer rounded-r-xl border-b-2 bg-stone-100 flex items-center flex-row   w-2/6 justify-center">
      ...
      <div className="flex flex:col lg:flex-row p-2  border-t-2 justify-between">
