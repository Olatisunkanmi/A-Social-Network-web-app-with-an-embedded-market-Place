	...
	return (
		<div className='bg-white flex flex-row border-2 rounded-xl border-neutral-400 mb-10'>
			<div className='flex flex-col  p-5 w-full  '>
				...
				<div className='flex flex-col md:flex-row space-y-2 md:space-x-3 mt-5'>
					<div className='flex flex-col border-2 p-2 rounded-lg w-full md:w-1/2  '>
				...
				<div className='mt-3 p-2'>
					<p className='w-1/2 font-semibold'>
						{' '}
						Be sure to fill out your location settings. This will help
						us suggest you relevant friends and places you could like{' '}
					</p>
				...
				<div className=' mt-4 lg:mt-10 lg:space-x-2 w-full '>
					...
					<button className='py-3 m-1 text-white font-semibold  rounded-xl  px-7 bg-red-500'>
						{' '}
						Discard Changes{' '}
					</button>
				</div>
