...
const Payment = () => {
	return (
		<div className='mt-10 m-auto lg:w-4/5 xl:w-3/5 flex flex-col'>
			{/**   Cart Header  */}
			...
			<div className='w-full flex flex-col lg:flex-row mt-10 justify-between md:space-x-10'>
				<div className='w-3/6  '>
					<div className='bg-white p-5 space-y-10 payment'>
						<div className=''>
				...
				<div className='w-3/6 bg-white p-5 border-2 border-neutral-400 payment'>
					<ContactCard />
				</div>
			</div>
		</div>
